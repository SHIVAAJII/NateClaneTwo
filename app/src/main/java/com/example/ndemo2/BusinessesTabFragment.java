...
public class BusinessesTabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_services_tab, container, false);


        listView=(ListView) view.findViewById(R.id.services_listViewId);
